...
from utils.GraphVisualizer import GraphVisualization
import logging
    ...
    def generate_knowledge_graph(self, search_topic):
        try:
            ...
            loader = DirectoryLoader(
                inputdirectory, glob="**/*.pdf", show_progress=True
            )
            ...
            # Extract concepts
            concepts_list = df2Graph(df, model="llama3.2:latest")
            ...
            logging.exception(
                f"An error occurred while generating the knowledge graph: {e}"
            )
            return None
